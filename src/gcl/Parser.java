...
// GCL Version 2011
	...
	public static final int _option1 = 38;
	public static final int _option3 = 39;
	public static final int _option5 = 40;
	public static final int _option6 = 41;
	public static final int _option7 = 42;
	public static final int _option9 = 43;
	public static final int _option10 = 44;
...
/*==========================================================*/
	...
	void gcl() {
		...
		while (!(la.kind == 0 || la.kind == 3)) {SynErr(38); Get();}
		module(scope);
		while (la.kind == 3) {
			scope = scope.openScope(true);
			while (!(la.kind == 0 || la.kind == 3)) {SynErr(39); Get();}
			module(scope);
		}
		semantic.finishCode();
	}
	...
	void statementPart(SymbolTable scope) {
		while (!(StartOf(3))) {SynErr(42); Get();}
		statement(scope);
		ExpectWeak(8, 4);
		while (StartOf(5)) {
			while (!(StartOf(3))) {SynErr(43); Get();}
			statement(scope);
			ExpectWeak(8, 4);
		}
	}
	...
	private boolean[][] set = {
		{T,T,x,T, x,x,T,x, x,x,T,T, T,x,x,T, T,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,x,x,x, x,x,x,x, x,x,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,T, T,T,T,x, x,x,T,T, T,x,x,T, T,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,T, x,x,T,T, x,x,T,T, T,x,x,T, T,T,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,T,T,x, x,x,x},
		{x,T,T,x, x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,T, x,T,x,T, T,x,x,x, x,x,x,x, x,x,x}
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
			...
			case 38: s = "this symbol not expected in gcl"; break;
			case 39: s = "this symbol not expected in gcl"; break;
			case 40: s = "this symbol not expected in definitionPart"; break;
			case 41: s = "this symbol not expected in block"; break;
			case 42: s = "this symbol not expected in statementPart"; break;
			case 43: s = "this symbol not expected in statementPart"; break;
			case 44: s = "invalid statement"; break;
			case 45: s = "invalid type"; break;
			case 46: s = "invalid typeSymbol"; break;
			case 47: s = "invalid simpleExpr"; break;
			case 48: s = "invalid relationalOperator"; break;
			case 49: s = "invalid addOperator"; break;
			case 50: s = "invalid factor"; break;
			case 51: s = "invalid multiplyOperator"; break;
			case 52: s = "invalid booleanConstant"; break;
